...
return (
        ...
        <main>
                ...
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    <div className="resources-left">
                      ...
                      <div className="resources-input-sec d-none">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12 columnBox custome-column-box mb-20">
                      <div className="custome-column-boxinner">
                        <a href="https://apexxcapital.co/resources/what-is-disc-assessment">
                          <div className="resources-blog-box">
                            <div className="custome-thumb">
                              <img src="https://fffmestb.blob.core.windows.net/vectracs/resources/{post-2024-45-27 02:45:44-RESOURCE-x}/image01.jpg" alt="" />
                            </div>
                            {/*<div class="resources-blog-box-inner">*/}
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12 columnBox custome-column-box mb-20">
                      <div className="custome-column-boxinner">
                        <a href="https://apexxcapital.co/resources/how-to-choose-an-esg-reporting-framework">
                          <div className="resources-blog-box">
                            <div className="custome-thumb">
                              <img src="https://fffmestb.blob.core.windows.net/vectracs/resources/{post-2024-17-05 12:17:15-RESOURCE-x}/image01.jpg" alt="" />
                            </div>
                            {/*<div class="resources-blog-box-inner">*/}
              ...
              <div className="container-wrapper">
                ...
                <div className="resources-blog-bottom pt-30">
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12 columnBox custome-column-box mb-20">
                      <div className="custome-column-boxinner">
                        <a href="https://apexxcapital.co/resources/zusammenfassung-der-esg-neuigkeiten+">
                          <div className="resources-blog-box">
                            <div className="custome-thumb">
                              <img src="https://fffmestb.blob.core.windows.net/vectracs/resources/{post-2024-40-09 11:40:30-RESOURCE-a}/image01.png" alt="" />
                            </div>
                            {/*<div class="resources-blog-box-inner">*/}
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12 columnBox custome-column-box mb-20">
                      <div className="custome-column-boxinner">
                        <a href="https://apexxcapital.co/resources/esg-news-round-up">
                          <div className="resources-blog-box">
                            <div className="custome-thumb">
                              <img src="https://fffmestb.blob.core.windows.net/vectracs/resources/{post-2024-13-09 07:13:49-RESOURCE-a}/image01.png" alt="" />
                            </div>
                            {/*<div class="resources-blog-box-inner">*/}
                            {/*   <p>Von der Regulierung zur Innovation: Zusammenfassung der ESG-Neuigkeiten </p>*/}
                            {/*</div>*/}
              ...
              <div className="container-wrapper">
                ...
                <div className="resources-blog-bottom pt-30">
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12 columnBox custome-column-box mb-20">
                      <div className="custome-column-boxinner">
                        <a href="https://apexxcapital.co/resources/vectra-international-klappir-partnership">
                          <div className="resources-blog-box">
                            <div className="custome-thumb">
                              <img src="https://fffmestb.blob.core.windows.net/vectracs/resources/{post-2024-52-21 10:52:15-RESOURCE-p}/image01.jpg" alt="" />
                            </div>
                            {/*<div class="resources-blog-box-inner">*/}
                            {/*   <p>VECTRA International and Klappir Forge Alliance to Assessment and Reporting of Sustainable Business Practices</p>*/}
                            {/*</div>*/}
          ...
          <section className="pt-80 pb-80 getInTouchSec" data-background="https://apexxcapital.co/images/bg/getInTouch-bg.webp" id="getInTouch" style={{backgroundImage: 'url("https://apexxcapital.co/images/bg/getInTouch-bg.webp")'}}>
            <div className="container">
